...
def get_coorindates(data_directory, block_size = (3, 3, 3), min_distance = 3, threshold_abs = 2.0):
    ...
    csv_file_name = f'studies_summary_R{min_distance}_TH_{threshold_abs}_updated.csv'
    ...
    with open(csv_file_name, mode='w', newline='') as file:
        ...
        if file.tell() == 0:
            csv_writer.writerow(['Patient ID', 'Study ID', 'Positive Length', 'Negative Length', 'Total Length'])
...
# 
                ...
                csv_writer.writerow([patient_id, study_id, pos_coord_length, neg_coord_length, total_coord_length])
